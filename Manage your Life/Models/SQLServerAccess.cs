...
namespace Manage_your_Life.Models
{
    ...
    /// データベースを操作するクラス
    /// </summary>
    public sealed class SQLServerAccess : IDatabaseAccess
    {
        private static readonly SQLServerAccess instance = new SQLServerAccess();
        ...
        public static SQLServerAccess Instance
            => instance;
